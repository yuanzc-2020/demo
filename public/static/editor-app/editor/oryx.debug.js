...
ORYX.Core.StencilSet.StencilSet = Clazz.extend({
	...
	construct: function (source, modelMetaData, editorId) {
		...
		if (ORYX.CONFIG.BACKEND_SWITCH) {
			...
			//ACTIVITI.CONFIG.static + '/stencilset.json?version=' + Date.now();
			//ACTIVITI.CONFIG.static + '/act/editor/stencilset?version=' + Date.now(),
			new Ajax.Request(ACTIVITI.CONFIG.static + '/stencilset.json?version=' + Date.now(), {
				asynchronous: false,
				method: 'get',
