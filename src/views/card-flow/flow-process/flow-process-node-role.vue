	...
	<div>
		...
		<Card class="card-margin-top">
			...
			<Row class="search" type="flex" :gutter="16" justify="left">
				...
				<Col span="8">
					<Card dis-hover>
						<p slot="title">待选择公司角色</p>
						<div class="tree-bar" style="height:380px;">
							<!--树形-->
							<Tree ref="treeUser" :data="treeDataRole" :render="renderContent1"></Tree>
				...
				<Col span="8">
					<Card dis-hover>
						<p slot="title">已授权审批角色</p>
						<div class="tree-bar" style="height:380px;">
							<!--树形-->
							<Tree
								ref="treeUserSelect"
								:data="treeDataRoleSelect"
...
import { getRoleList } from '@/api/card-system-api';
export default {
	props: {
			...
			nodeRelateList(paras).then(res => {
				if (res.success) {
					...
					if (rst != null) {
						...
						this.treeDataRoleSelect = tempDatas;
					}
