...
<template>
	<div class="search">
		...
		<Card v-show="currView=='index'">
			<Row v-show="openSearch" @keydown.enter.native="handleSearch">
				<Form ref="searchForm" :model="searchForm" inline :label-width="100">
					<Form-item label="数据状态" prop="statusCode">
						<Select v-model="searchForm.statusCode" style="width: 250px;">
							<Option
			...
			<Row class="operation">
				<Button @click="add" type="primary" icon="md-add">新增调拨单</Button>
				<Button @click="processSubmit" type="warning" icon="md-paper-plane">流程提交</Button>
				<Button @click="processTrace" type="warning" icon="md-git-branch">流程跟踪</Button>
